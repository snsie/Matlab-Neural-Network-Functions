function [savet_corr ,savetr_corr ,saveerr ,savefract_corr ,savefract_corr_test ,wremtot] = Run_Grad(act_type, num_lay,nodes_per_lay,nstep,M,numitr,numruns,x,xtest,desired,destest )
...
x=x(ix',:);
desired=desired(ix',:);
[w, wsave,sum1, err, out] = train(w,x,desired,num_lay,num_nodes,actf,dactf,calcj,calcm,wch,wsave,out,num_in,num_out,M,sum1,err,w2);
